...
ROUTING_TOOLS = [
    ...
    },
    {
        ...
        "description": "v2 unified force-directed PCB autoplacer (shares the schematic autoplacer engine). Pin-wise springs (strength per spring class: DECOUPLING strong, LOCAL_SIGNAL default, INTER_GROUP weak, PLANE zero) + OBB-cubic-ramp body repulsion. Anchored components (J*/SW*/BAT* and through-hole-dominant by default; override with lockedRefs) stay fixed. 4-phase schedule: cluster -> spread -> snap -> relax. Power-plane nets auto-classify as PLANE.",
        "inputSchema": {
            "type": "object",
            "properties": {
                "lockedRefs": {
                ...
                "springK": {"type": "number", "description": "Base attraction spring constant (default 0.1).", "default": 0.1},
                "repulsionKStart": {"type": "number", "description": "Repulsion strength at start of spread phase (default 0.05). Ramps geometrically to repulsionKPeak.", "default": 0.05},
                "repulsionKPeak": {"type": "number", "description": "Peak repulsion strength at end of spread phase (default 30.0).", "default": 30.0},
                "rotationSnapPeak": {"type": "number", "description": "Peak rotation-snap torque (default 3.0). Set 0 for free rotation.", "default": 3.0},
                "pinwiseTorqueK": {"type": "number", "description": "Lever-arm torque coupling for pin-wise springs (default 0.05). Without this, off-center spring forces don't rotate components.", "default": 0.05},
                "clusterIters": {"type": "number", "description": "Phase 1 iterations (default 30).", "default": 30},
                "spreadIters": {"type": "number", "description": "Phase 2 iterations (default 40).", "default": 40},
