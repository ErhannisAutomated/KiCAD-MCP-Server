    ...
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "clusterIters": {"type": "number", "description": "Phase 1 (springs only) iterations (default 0 — the SPREAD phase starts repulsion near zero so cluster is effectively absorbed).", "default": 0},
