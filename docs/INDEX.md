...
| [Topology Tools Plan](TOPOLOGY_TOOLS_PLAN.md) | Trace-width config-space analysis (project **complete**; reference docs in `Routing Topology Analysis` section of [ROUTING_TOOLS_REFERENCE](ROUTING_TOOLS_REFERENCE.md)) |
